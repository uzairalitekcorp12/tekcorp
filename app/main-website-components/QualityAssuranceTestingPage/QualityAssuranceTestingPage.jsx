    ...
    <div className="quality-assurance-page">
      <section className="quality-assurance-hero">
        <div className="service-page-shell quality-assurance-hero__content">
          ...
          <ServiceBreadcrumb
            className="quality-assurance-breadcrumb"
            current="Quality Assurance & Testing"
            separator="›"
            showArrow
      ...
      <section className="quality-assurance-process" aria-labelledby="quality-process-title">
        <div className="service-page-shell">
          <SectionHeading
            className="quality-assurance-process__header"
            reveal="up"
            kicker="How we work"
            title="The 4 keys to ensure quality assurance"
            titleId="quality-process-title"
          />
      ...
      <section className="quality-assurance-benefits">
        <SplitContent
          className="service-page-shell quality-assurance-benefits__grid"
          copyClassName="quality-assurance-benefits__copy"
          mediaClassName="quality-assurance-benefits__media"
          copy={
            <>
