    ...
    >
      <div className="video-header sr">
        ...
        <p className="video-description">
          A closer look at the vision, work, and decisions
          that shaped Tekcorp into a modern digital brand.
        </p>
      </div>
      ...
      <div className="video-wrapper">
        <div className="video-inner">
          ...
          <div className="video-caption">
            ...
            <strong>
              See How Taha Sheikh Built Tekcorp Into a Brand
            </strong>

            <p>
              From an idea to a growing digital company —
              discover the thinking, execution, and ambition
              behind Tekcorp.
            </p>
          </div>
